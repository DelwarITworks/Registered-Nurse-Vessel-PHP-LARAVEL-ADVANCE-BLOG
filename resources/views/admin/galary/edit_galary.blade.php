        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="{{ route('update.galary',$galary->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group  row"><label class="col-sm-2 col-form-label text-right">Title</label>
                            <div class="col-sm-10"><input value="{{ $galary->title }}" type="text"  name="title" class="form-control  @error('title') is-invalid @enderror"><span class="form-text m-b-none">Enter a Name..</span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4"><input type="file" onchange="photoChange(this)"  class="form-control" name="image">
                                <input type="hidden" name="old_image" value="{{ $galary->image }}">
                                @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-sm-6">
                                <img src="{{ asset('storage/app/public/'.$galary->image) }}" id="productphoto1" class="img-thumbnail" height="50px" width="auto" alt="">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
